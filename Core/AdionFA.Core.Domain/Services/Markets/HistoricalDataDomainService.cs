...
namespace AdionFA.Core.Domain.Services.Markets
{
    public class HistoricalDataDomainService : DomainServiceBase, IHistoricalDataDomainService
    {
        // Repositories
        ...
        public HistoricalDataDomainService(string tenantId, string ownerId, string owner,
        ...
        public int CreateHistoricalData(HistoricalData market)
        {
            try
            {
                ...
                //HistoricalDataRepository.CloseTemporalRecord();
