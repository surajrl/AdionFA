...
namespace Adion.FA.Infrastructure.Common.Infrastructures.AssembledBuilder.Services
{
                        ...
                        Parallel.ForEach(templates,
                            ...
                            fi =>
                            {
                                ...
                                List<IndicatorBase> extractions = ExtractorService.ExtractorExecute(
                                    first, last, indicators, candles, config.CurrencyPeriodId, config.Variation);
