...
namespace Adion.FA.Infrastructure.Enums
{
    ...
    public enum CurrencyPeriodEnum
    {
        [Metadata("M1", "M1", valueKey:"60", resourceType: typeof(EnumResources))]
        M1 = 1,
        [Metadata("M5", "M5", valueKey: "300", resourceType: typeof(EnumResources))]
        M5 = 2,
        [Metadata("M15", "M15", valueKey: "900", resourceType: typeof(EnumResources))]
        M15 = 3,
        [Metadata("M30", "M30", valueKey: "1800", resourceType: typeof(EnumResources))]
        M30 = 4,
        [Metadata("H1", "H1", valueKey: "3600", resourceType: typeof(EnumResources))]
        H1 = 5,
        [Metadata("H4", "H4", valueKey: "14400", resourceType: typeof(EnumResources))]
        H4 = 6,
        [Metadata("D1", "D1", valueKey: "86400", resourceType: typeof(EnumResources))]
        Daily = 7,
        [Metadata("W", "W", valueKey: "604800", resourceType: typeof(EnumResources))]
        W = 8,
        [Metadata("MN", "MN", valueKey: "2592000", resourceType: typeof(EnumResources))]
        MN = 9,
    }
