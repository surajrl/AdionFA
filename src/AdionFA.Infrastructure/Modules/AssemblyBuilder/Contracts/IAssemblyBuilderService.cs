...
namespace AdionFA.Infrastructure.AssemblyBuilder.Contracts
{
    ...
    {
        /// <summary>
        /// Creates a new Assembly Builder and gets the child nodes from the Node Builder.
        /// </summary>
        /// <param name="projectName"></param>
        AssemblyBuilderModel CreateNewAssemblyBuilder(string projectName);

        /// <summary>
        /// Gets the Assembly Builder winning nodes found on the directory and the child nodes from the Node Builder.
        /// </summary>
        /// <param name="projectName"></param>
