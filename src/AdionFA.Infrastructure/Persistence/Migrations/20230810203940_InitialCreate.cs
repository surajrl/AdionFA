    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 6, 6, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8578), false, 4m, 4m, 2m, 2m, 100, 1000, null, 6, 1.5m, 300, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8608), false, 4m, 4m, 2m, 2m, 6, 6, 1000, null, 6, 1.5m, 300, 1 });

            migrationBuilder.InsertData(
                table: "Market",
                columns: new[] { "MarketId", "Code", "CreatedOn", "IsDeleted", "Name", "UpdatedOn", "Value" },
                values: new object[] { 1, "Forex", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(7971), false, "Forex", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "America", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8187), false, "America", null, null },
                    { 2, "Europe", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8328), false, "Europe", null, null },
                    { 3, "Asia", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8467), false, "Asia", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8547), false, 5m, 40m, 40m, 200, 100, 6, 6, 100, null, 12, 1.5m, 300, 4 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Culture", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(5220), false, "Culture", null, "eng" },
                    { 2, "Theme", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(5421), false, "Theme", null, "Light" },
                    { 3, "Color", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(5570), false, "Color", null, "Orange" },
                    { 4, "DefaultWorkspace", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(5727), false, "DefaultWorkspace", null, "" },
                    { 5, "Host", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(5871), false, "Host", null, "192.168.50.137" },
                    { 6, "Port", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(6025), false, "Port", null, "5555" }
                });

            migrationBuilder.InsertData(
                table: "Symbol",
                columns: new[] { "SymbolId", "Code", "CreatedOn", "IsDeleted", "Name", "UpdatedOn", "Value" },
                values: new object[] { 1, "EURUSD", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(6272), false, "EURUSD", null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "M1", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(6553), false, "1 Minute", null, "1" },
                    { 2, "M5", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(6709), false, "5 Minutes", null, "5" },
                    { 3, "M15", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(6847), false, "15 Minutes", null, "15" },
                    { 4, "M30", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(6989), false, "30 Minutes", null, "30" },
                    { 5, "H1", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(7169), false, "1 Hour", null, "16385" },
                    { 6, "H4", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(7322), false, "4 Hours", null, "16388" },
                    { 7, "D1", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(7467), false, "Daily", null, "16408" },
                    { 8, "W1", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(7605), false, "Weekly", null, "32769" },
                    { 9, "MN1", new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(7755), false, "Monthly", null, "49153" }
                });

            migrationBuilder.InsertData(
                table: "GlobalConfiguration",
                columns: new[] { "GlobalConfigurationId", "AssemblyBuilderConfigurationId", "CreatedOn", "CrossingBuilderConfigurationId", "ExpertAdvisorHost", "ExpertAdvisorPublisherPort", "ExpertAdvisorResponsePort", "ExtractorMinVariation", "FromDateIS", "FromDateOS", "IsDeleted", "IsProgressiveness", "MaxCorrelationPercent", "MaxProgressivenessVariation", "MaximumSeed", "MinimalSeed", "NodeBuilderConfigurationId", "ToDateIS", "ToDateOS", "TotalDecimalWeka", "UpdatedOn", "WithoutSchedule" },
                values: new object[] { 1, 1, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8509), 1, "192.168.1.35", "5551", "5550", 50, null, null, false, false, 2m, 2m, 1000000, 100, 1, null, null, 5, null, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8634), 54000, 1, false, 1, 82800, null },
                    { 2, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8636), 32400, 1, false, 2, 64800, null },
                    { 3, new DateTime(2023, 8, 10, 20, 39, 40, 35, DateTimeKind.Utc).AddTicks(8637), 3600, 1, false, 3, 32400, null }
                });
