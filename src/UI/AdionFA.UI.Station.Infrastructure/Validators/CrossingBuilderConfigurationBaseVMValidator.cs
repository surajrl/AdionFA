...
{
    public class CrossingBuilderConfigurationBaseVMValidator : AbstractValidator<CrossingBuilderConfigurationVM>
    {
        public CrossingBuilderConfigurationBaseVMValidator()
        {
